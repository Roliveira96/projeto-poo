...
/**
 * Família Cyber: quatro produtos concretos feitos para funcionar juntos.
 */
...
export class LocomocaoCyber implements Locomocao {
  private readonly nome: string = 'Flutuador Magnético';
  private readonly icone: string = '🧲';
  private readonly cor: string = '#b388ff';
  private readonly velocidade: number = 70;
  ...
  public mover(): string {
    return 'Levitação magnética: desliza sem tocar o chão.';
  }
}
